...
class ProfileTest(TestCase):
   ...
   class ProjectTest(TestCase):
    ...
    def setUp(self):
        ...
        self.project = Project.objects.create(posted_by = self.user, profile = self.profile, title = 'Gram', description='king', project_link= 'https://clydegram.herokuapp.com/')
    ...
    def test_find_project(self):
        self.project.save()
        project = Project.find_project('gram')
...
class ReviewsTest(TestCase):
    def setUp(self):
        ...
        self.review= Reviews.objects.create(juror= self.user, design=5, usability=5,content=5,comment="dope" )
